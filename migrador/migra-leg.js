...
csv({delimiter:";"})
    ...
    .on('json', (jsonObj, rowIndex)=> {
        ...
        if(legCatalog.indexOf(lcode) === -1){
            ...
            var mytit = jsonObj['Título / âmbito do diploma'].replace(/\"/gm,"\\\"")
            ...
            currentStatements += "\t:diplomaTitulo " + "\"" + mytit + "\";\n"
    ...
    .on('done', (error)=> {
        ...
        fs.writeFileSync("../dados/leg.json", JSON.stringify(legCatalog, null, 2))
    })